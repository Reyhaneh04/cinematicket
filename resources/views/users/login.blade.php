			...
			<div class="row">
				<div class="col-12">
					<div class="sign__content">
						<!-- authorization form -->
						<form action="{{ route('login') }}" class="sign__form" method="POST" style="direction:rtl;">
                          @csrf
                           ...
                           <div class="sign__group">
                            ...
                            @error('username')
                             ...
                             <div class="sign__group">
                            <input type="password" class="sign__input" name="password" placeholder="کلمه عبور">
                          ...
                          @if ($errors->has('username') || $errors->has('password'))
                           <p class="text-red-500 text-xs mt-1 " style="color:white">نام کاربری یا رمز عبور اشتباه است.</p>
                        @endif

	                     <input type="hidden" name="redirect" value="{{ request('redirect') }}">
                         <button class="sign__btn" type="submit">ورود</button>

                          <span class="sign__text">حساب کاربری ندارید؟ <a href="{{ route('register', ['redirect' => request('redirect')]) }}">ثبت نام</a></span>
                          </form>
